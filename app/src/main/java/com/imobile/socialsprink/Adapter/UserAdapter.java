...
import com.imobile.socialsprink.databinding.UserSampleBinding;
                ...
                .child(FirebaseAuth.getInstance().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            holder.binding.followBtn.setTextColor(context.getColor(R.color.darkGrey));
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference()
                                                            ...
                                                            .setValue(user.getFollowerCount() + 1).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                ...
                                                                public void onSuccess(Void unused) {
                                                                    holder.binding.followBtn.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.follow_active_btn));
                                                                    holder.binding.followBtn.setText("Following");
                                                                    holder.binding.followBtn.setTextColor(context.getColor(R.color.grey));
                                                                    holder.binding.followBtn.setEnabled(false);
